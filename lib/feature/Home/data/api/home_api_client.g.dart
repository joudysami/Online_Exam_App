...
class _HomeApiClient implements HomeApiClient {
  ...
  @override
  Future<ExamsResponse> getAllExams() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<CheckAnswersResponse> checkAnswers(CheckAnswersRequest request) async {
    ...
    final _options = _setStreamType<CheckAnswersResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CheckAnswersResponse _value;
    try {
      _value = CheckAnswersResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
