...
import 'package:exam_app/feature/Auth/presentation/login/view/widgets/custom_textfeild.dart';
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              Icon(AppIcons.arrowBack, color: AppColors.black, size: 25.w),
              SizedBox(width: 10.w),
              Text(
                'Login',
                style: TextStyle(
              ...
              Row(
                ...
                children: [
                  Checkbox(
                    ...
                    side: BorderSide(color: AppColors.grey, width: 1.5.w),
                  ...
                  TextButton(
                    ...
                    child: Text(
                      'Forgot Password?',
                      style: TextStyle(color: AppColors.blue, fontSize: 14.sp, decoration: TextDecoration.underline),
                    ),
                  ),
                ],
              ),
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text(
                      'Sign Up',
                      style:
                          TextStyle(color: AppColors.blue, fontSize: 14.sp,decoration: TextDecoration.underline,),
                    ),
                  ),
                ],
              ),  
